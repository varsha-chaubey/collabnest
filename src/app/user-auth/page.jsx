...
const page = () => {
    ...
    const handleLogin = async (provider) => {
        ...
        try {
            ...
            toast.info(`Loggin with ${provider}`)
        } catch (error) {
    ...
    return (
        <div className='flex min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800'>
            ...
            <div className='hidden w-1/2 bg-gray-100 lg:block'>
                <Image src="/images/meet_image.jpg" width={1080} height={1080} alt="login" className='object-cover h-full w-full' />
            ...
            <div className='flex flex-col justify-center w-full p-8 lg:w-1/2 '>
                <div className='max-w-md mx-auto'>
                    ...
                    Where remote teams come together to turn ideas into reality. Discover the power of unified teamwork, all from the comfort of your chosen workspace.
                    </p>
                    <div className='space-y-4'>
                        <Button
                            onClick={() => handleLogin('google')}
                            className="w-full dark:hover:bg-white dark:hover:text-black" variant="outline">
                            <svg
                    ...
                    <div className='flex flex-col space-y-4 mt-6'>
                        ...
                        <Button
                            ...
                            className="w-full bg-black text-white dark:hover:bg-gray-200 dark:bg-white  dark:hover:text-black " variant="ghost">
